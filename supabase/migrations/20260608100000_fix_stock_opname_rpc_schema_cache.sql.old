-- Fix: ensure stock opname RPC functions exist and refresh PostgREST schema cache
-- Root cause: 20260608000000 migration did not NOTIFY pgrst after creating RPCs
