-- Keep product_variants.attributes aligned with the inventory mutation RPC.
-- Empty variant attributes are represented as an empty JSON object instead of NULL.
