...
export function MyTicketsTabs({
  ...
  const tabs = [
    {
      id: 'pending' as const,
      label: t('myTickets.tabs.pending', 'Pending'),
      icon: 'schedule',
    ...
    {
      id: 'active' as const,
      label: t('myTickets.tabs.active'),
      icon: 'confirmation_number',
      activeClass: 'bg-rose-500 text-white shadow-sm',
      inactiveBadgeClass: 'bg-rose-100 text-rose-700',
      activeBadgeClass: 'bg-white text-rose-600',
      count: activeCount,
    },
    {
      id: 'history' as const,
      label: t('myTickets.tabs.history'),
      icon: 'history',
